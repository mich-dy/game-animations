...
void UserInterface::createFrame(VkRenderData& renderData) {
  ...
  if (ImGui::CollapsingHeader("glTF Inverse Kinematic")) {
    ...
    if (renderData.rdIkMode == ikMode::ccd ||
      ...
      ImGui::Checkbox("Draw Target Coordinates", &renderData.rdTargetCoordLines);
      ...
      ImGui::PopStyleColor();
      ImGui::SameLine();
      ImGui::SliderFloat3("##STARTVEC", glm::value_ptr(renderData.rdSplineStartVertex), -10.0f, 10.0f, "%.3f", flags);

      ImGui::PushStyleColor(ImGuiCol_Text, IM_COL32(0, 0, 0, 255));
      ImGui::Text("Start Tang ");
      ImGui::PopStyleColor();
      ImGui::SameLine();
      ImGui::SliderFloat3("##STARTTANG", glm::value_ptr(renderData.rdSplineStartTangent), -10.0f, 10.0f, "%.3f", flags);

      ImGui::PushStyleColor(ImGuiCol_Text, IM_COL32(255, 255, 255, 255));
      ImGui::Text("End Vec    ");
      ImGui::PopStyleColor();
      ImGui::SameLine();
      ImGui::SliderFloat3("##ENDVEC", glm::value_ptr(renderData.rdSplineEndVertex), -10.0f, 10.0f, "%.3f", flags);

      ImGui::PushStyleColor(ImGuiCol_Text, IM_COL32(255, 255, 255, 255));
      ImGui::Text("End Tang   ");
      ImGui::PopStyleColor();
      ImGui::SameLine();
      ImGui::SliderFloat3("##ENDTANG", glm::value_ptr(renderData.rdSplineEndTangent), -10.0f, 10.0f, "%.3f", flags);
