...
struct VkRenderData {
  ...
  bool rdTargetCoordLines = true;

  glm::vec3 rdSplineStartVertex = glm::vec3(-4.0f, 1.0f, -2.0f);
  glm::vec3 rdSplineStartTangent = glm::vec3(-10.0f, -8.0f, 8.0f);
  glm::vec3 rdSplineEndVertex = glm::vec3(4.0f, 2.0f, -2.0f);
  glm::vec3 rdSplineEndTangent = glm::vec3(-6.0f, 5.0f, -6.0f);
