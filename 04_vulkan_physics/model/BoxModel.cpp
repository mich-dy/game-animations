...
void BoxModel::init() {
  ...
  mVertexData.vertices[0].uv = glm::vec2(0.0f, 1.0);
  mVertexData.vertices[1].uv = glm::vec2(1.0f, 0.0f);
  mVertexData.vertices[2].uv = glm::vec2(0.0f, 0.0f);
  mVertexData.vertices[3].uv = glm::vec2(0.0f, 1.0f);
  mVertexData.vertices[4].uv = glm::vec2(1.0f, 1.0f);
  mVertexData.vertices[5].uv = glm::vec2(1.0f, 0.0f);
